...
function depthFirst(input, dir = "r", n = 0, visited = {}) {
	...
	if (input[n + lookup[dir]] === ".") {
		return depthFirst(input, dir, n + lookup[dir], visited)
	}
	switch (dir) {
		case "l": {
			if (input[n + lookup[dir]] === "/") {
				return depthFirst(input, "d", n + lookup[dir], visited)
			}
		}
		case "r": {
			if (input[n + lookup[dir]] === "-") {
			...
			if (input[n + lookup[dir]] === "/") {
				return depthFirst(input, "u", n + lookup[dir], visited)
			}
			if (input[n + lookup[dir]] === "\\") {
				return depthFirst(input, "d", n + lookup[dir], visited)
			}
		...
		case "u": {
			if (input[n + lookup[dir]] === "/") {
				return depthFirst(input, "r", n + lookup[dir], visited)
			}
			if (input[n + lookup[dir]] === "\\") {
				return depthFirst(input, "l", n + lookup[dir], visited)
			}
		}
		case "d": {
			if (input[n + lookup[dir]] === "|") {
